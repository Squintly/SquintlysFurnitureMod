...
public class PurpleSilkFlowersTile : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<PurpleSilkFlowers>());
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        short frameAdjustment = (short)(tile.TileFrameX >= 180 ? -180 : 18); //change last two depending on size
