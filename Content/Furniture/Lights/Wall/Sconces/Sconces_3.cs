...
{
    internal class Sconces_3 : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Furniture/Lights/Wall/Sconces/Sconces_3"); // We could also reuse Main.FlameTexture[] textures, but using our own texture is nice.
            }
        }
        ...
        public void ToggleTile(int i, int j)
        {
            ...
            short frameAdjustment = (short)(tile.TileFrameX > 264 ? -264 : 264);
