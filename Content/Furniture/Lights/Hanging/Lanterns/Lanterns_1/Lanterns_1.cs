...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Hanging.Lanterns.Lanterns_1
{
    [LegacyName("Lanterns")]
    public class Lanterns_1 : ModTile
    {
        public enum StyleID
        {
            FestiveLantern, //0
        ...
        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
        {
            ...
            switch (style)
            {
                case StyleID.FestiveLantern: //Warm
                    r = 1f;
                    g = .95f;
                    b = .65f;
                    break;

                case StyleID.HeartfeltLantern: //Reddish
                    r = 1f;
                    g = .75f;
                    b = .65f;
                    break;
        ...
        public override void AdjustMultiTileVineParameters(int i, int j, ref float? overrideWindCycle, ref float windPushPowerX, ref float windPushPowerY, ref bool dontRotateTopTiles, ref float totalWindMultiplier, ref Texture2D glowTexture, ref Color glowColor)
        {
            ...
            switch (style)
            {
                case StyleID.FestiveLantern: //Default
                case StyleID.HeartfeltLantern:
                    break;
        ...
        public override void GetTileFlameData(int i, int j, ref TileDrawing.TileFlameData tileFlameData)
        {
            ...
            switch (style)
            {
                case StyleID.FestiveLantern: //Low flicker
                ...
                case StyleID.HeartfeltLantern: //Less glow, no flicker
