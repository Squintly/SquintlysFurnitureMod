...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Surface.Candlesticks.Candlesticks_5
{
    internal class Candlesticks_5 : ModTile
    {
        public enum StyleID
        {
            TatteredCandlestick, //0
            TatteredSilverCandlestick, //1
            RepairedCandlestick, //2
            RepairedSilverCandlestick, //3
        }
        ...
        public void ToggleTile(int i, int j)
        {
            ...
            short frameAdjustment = (short)(tile.TileFrameX >= 170 ? -170 : 170);
        ...
        {
            if (Main.tile[i, j].TileFrameX / 170 != 0)
            {
                return;
            }
            ...
            switch (style)
            {
                case StyleID.TatteredCandlestick: //Cool
                ...
                case StyleID.RepairedCandlestick: //Cool
        ...
        public override void EmitParticles(int i, int j, Tile tileCache, short tileFrameX, short tileFrameY, Color tileLight, bool visible)
        {
            ...
            if (Main.rand.NextBool(40) && tileFrameX < 170)
            {
                StyleID style = (StyleID)TileObjectData.GetTileStyle(Main.tile[i, j]);
