...
using SquintlysFurnitureMod.Content.Items.Decorations.Holiday.Halloween.Candles.Tall;
using Terraria;
...
namespace SquintlysFurnitureMod.Content.Tiles.Decorations.Holiday.Halloween.Candles
{
    internal class SpookyCandlesTallBlack : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            TileObjectData.newTile.CoordinateHeights = new int[1] { 36 };
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Decorations/Holiday/Halloween/Candles/SpookyCandlesTallBlack_Flame");
            }
            RegisterItemDrop(ModContent.ItemType<SpookyCandlesTallBlackItem>());
        }
