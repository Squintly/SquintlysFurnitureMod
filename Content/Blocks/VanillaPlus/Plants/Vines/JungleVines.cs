...
public class JungleVines : VinesSilk
{
    public override void SafeSetStaticDefaults()
    {
        RegisterItemDrop(ModContent.ItemType<JungleVinesBasket>());
        AddMapEntry(new Color(102, 153, 0));
    }
}

public class JungleVinesBasket : ModItem
{
    ...
    {
        Item.DefaultToPlaceableTile(ModContent.TileType<JungleVines>());
