using SquintlysFurnitureMod.Content.Items.Decorations.VanillaPlus.Plants.Flowers;
using Terraria;
...
namespace SquintlysFurnitureMod.Content.Tiles.Decorations.VanillaPlus.Plants.Flowers;

public class SilkWildflowersTile : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        TileObjectData.newTile.RandomStyleRange = 70;
        ...
        RegisterItemDrop(ModContent.ItemType<SilkWildflowers>());
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        short frameAdjustment = (short)(tile.TileFrameX >= 1350 ? -1350 : 18); //change last two depending on size
