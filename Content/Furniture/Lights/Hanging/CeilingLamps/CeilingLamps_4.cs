...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Hanging.CeilingLamps
{
    internal class CeilingLamps_4 : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Furniture/Lights/Hanging/CeilingLamps/CeilingLamps_4_Flame"); // We could also reuse Main.FlameTexture[] textures, but using our own texture is nice.
            }
        }
        ...
        public void ToggleTile(int i, int j)
        {
            ...
            short frameAdjustment = (short)(tile.TileFrameX >= 128 ? -128 : 128);
