...
public class YellowSilkFlowersTile : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<YellowSilkFlowers>());
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        short frameAdjustment = (short)(tile.TileFrameX >= 234 ? -234 : 18); //change last two depending on size
