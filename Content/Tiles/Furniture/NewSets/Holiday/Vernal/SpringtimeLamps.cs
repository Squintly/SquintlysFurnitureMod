...
{
    internal class SpringtimeLamps : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Furniture/NewSets/Holiday/Vernal/SpringtimeLamps_Flame");
            }
        ...
        public void ToggleTile(int i, int j)
        {
            ...
            int topX = i - tile.TileFrameX % 24 / 18; //change first number depending on size
            int topY = j - tile.TileFrameY % 54 / 18;

            short frameAdjustment = (short)(tile.TileFrameX >= 24 ? -24 : 24); //change depending width
