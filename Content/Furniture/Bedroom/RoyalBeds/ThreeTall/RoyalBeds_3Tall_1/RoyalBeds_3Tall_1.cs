...
namespace SquintlysFurnitureMod.Content.Furniture.Bedroom.RoyalBeds.ThreeTall.RoyalBeds_3Tall_1
{
    [LegacyName("RoyalBeds_3Tall")]
    public class RoyalBeds_3Tall_1 : ModTile
    {
        public enum StyleID
        {
            StoneBrick, //0
