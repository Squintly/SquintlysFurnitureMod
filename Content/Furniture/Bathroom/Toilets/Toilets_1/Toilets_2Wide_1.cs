...
namespace SquintlysFurnitureMod.Content.Furniture.Bathroom.Toilets.Toilets_1
{
    public class Toilets_2Wide_1 : ModTile
    {
        public enum StyleID
        {
            Cinderblock, //0
        ...
        public override void ModifySittingTargetInfo(int i, int j, ref TileRestingInfo info)
        {
            ...
            info.AnchorTilePosition.Y = (tile.TileFrameY % 18 == 0) ? (j + 1) : j;
