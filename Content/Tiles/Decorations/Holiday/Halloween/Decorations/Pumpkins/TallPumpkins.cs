...
{
    internal class TallPumpkins : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Decorations/Holiday/Halloween/Decorations/Pumpkins/TallPumpkins_Flame");
            }

            RegisterItemDrop(ModContent.ItemType<PumpkinTallItem>());
        }
