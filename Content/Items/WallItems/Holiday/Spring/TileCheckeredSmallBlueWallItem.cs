...
internal class TileCheckeredSmallBlueWallItem : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.createWall = ModContent.WallType<TileCheckeredSmallBlueWall>();
    }

    public override void AddRecipes()
    {
        CreateRecipe(4)
           .AddIngredient(ModContent.ItemType<TileCheckeredSmallBlueItem>())
