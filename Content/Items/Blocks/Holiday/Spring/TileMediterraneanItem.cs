...
internal class TileMediterraneanItem : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.createTile = ModContent.TileType<TileMediterranean>();
    }
    ...
    public override void AddRecipes()
    {
        ...
        CreateRecipe()
           .AddIngredient(ModContent.ItemType<TileMediterraneanWallItem>(), 4)
