...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Surface.Lamps
{
    internal class Lamps_11 : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Furniture/Lights/Surface/Lamps/Lamps_11_Flame");
            }
        }
        ...
        public void ToggleTile(int i, int j)
        {
            ...
            short frameAdjustment = (short)(tile.TileFrameX >= 352 ? -352 : 352); //change last two depending on size
