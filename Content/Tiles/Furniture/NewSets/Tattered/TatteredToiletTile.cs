...
namespace SquintlysFurnitureMod.Content.Tiles.Furniture.NewSets.Tattered
{
	public class TatteredToiletTile : ModTile
	{
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<Items.Furniture.NewSets.Tattered.TatteredToiletItem>());
		}
		...
		public override void MouseOver(int i, int j) {
			...
			player.cursorItemIconID = ModContent.ItemType<Items.Furniture.NewSets.Tattered.TatteredToiletItem>();
