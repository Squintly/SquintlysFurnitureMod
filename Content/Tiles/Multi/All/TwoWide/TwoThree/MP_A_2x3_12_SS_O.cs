...
namespace SquintlysFurnitureMod.Content.Tiles.Multi.All.TwoWide.TwoThree
{
    public class MP_A_2x3_12_SS_O : ModTile
    {
        public enum StyleID
        {
            BannerWhitePointWide, //0
            BannerWhiteFlatWide, //1
            BannerWhiteRoundWide, //2
            BannerGrayPointWide, //3
            BannerGrayFlatWide, //4
            BannerGrayRoundWide, //5
            BannerBlackPointWide, //6
            BannerBlackFlatWide, //7
            BannerBlackRoundWide, //8
            BannerPastelPointWide, //9
            BannerPastelFlatWide, //10
            BannerPastelRoundWide, //11
            BannerBrightPointWide, //12
            BannerBrightFlatWide, //13
            BannerBrightRoundWide, //14
            BannerNavyPointWide, //15
            BannerNavyFlatWide, //16
            BannerNavyRoundWide, //17
            BannerPalePointWide, //18
            BannerPaleFlatWide, //19
            BannerPaleRoundWide, //20
            BannerDullPointWide, //21
            BannerDullFlatWide, //22
            BannerDullRoundWide, //23
            BannerDimPointWide, //24
            BannerDimFlatWide, //25
            BannerDimRoundWide //26
        }
