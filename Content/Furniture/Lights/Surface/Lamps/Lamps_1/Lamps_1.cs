...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Surface.Lamps.Lamps_1
{
    [LegacyName("Lamps")]
    internal class Lamps_1 : ModTile
    {
        public enum StyleID
        {
            ImperialLamp, //0
        ...
        public void ToggleTile(int i, int j)
        {
            ...
            short frameAdjustment = (short)(tile.TileFrameX >= 34 ? -34 : 34); //change last two depending on size
        ...
        {
            if (Main.tile[i, j].TileFrameX / 34 != 0)
            {
                return;
            }
            ...
            switch (style)
            {
                case StyleID.StoneBrickLamp:
                case StyleID.RedBrickLamp:
                    r = 1f;
                    g = .85f;
                    b = .70f;
                    break;
        ...
        //    if (Main.rand.NextBool(40) && tileFrameX / 34 != 0)
        //    {
        //        StyleID style = (StyleID)TileObjectData.GetTileStyle(Main.tile[i, j]);
        ...
        //    switch (style)
        //    {
        //        case StyleID.ImperialLamp: //Low glow, low flicker
