...
using SquintlysFurnitureMod.Content.Furniture.Lights.Hanging.Lanterns.Lanterns_2.Items;
...
{
    internal class TeakLanterns : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Furniture/NewSets/Woods/Teak/TeakLanterns_Flame"); // We could also reuse Main.FlameTexture[] textures, but using our own texture is nice.
            }

            AddMapEntry(new Color(200, 200, 200), Language.GetText("MapObject.Lantern"));

            RegisterItemDrop(ModContent.ItemType<TeakLanternItem>());
        }
