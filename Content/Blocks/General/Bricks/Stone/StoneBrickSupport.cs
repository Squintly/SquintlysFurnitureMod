...
public class StoneBrickSupport : UnsolidLazure
{
...
public class StoneBrickSupportItem : ModItem
{
    ...
    {
        Item.DefaultToPlaceableTile(ModContent.TileType<StoneBrickSupport>());
