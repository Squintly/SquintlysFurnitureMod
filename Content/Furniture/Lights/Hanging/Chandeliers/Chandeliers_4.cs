...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Hanging.Chandeliers
{
    internal class Chandeliers_4 : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Furniture/Lights/Hanging/Chandeliers/Chandeliers_4_Flame"); // We could also reuse Main.FlameTexture[] textures, but using our own texture is nice.
            }
        }
