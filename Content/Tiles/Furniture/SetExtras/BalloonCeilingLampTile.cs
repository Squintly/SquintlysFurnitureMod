...
namespace SquintlysFurnitureMod.Content.Tiles.Furniture.SetExtras
{
    internal class BalloonCeilingLampTile : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Furniture/SetExtras/BalloonCeilingLampTile_Flame"); // We could also reuse Main.FlameTexture[] textures, but using our own texture is nice.
            }
