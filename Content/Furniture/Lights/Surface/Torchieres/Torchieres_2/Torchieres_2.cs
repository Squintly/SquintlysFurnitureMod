...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Surface.Torchieres.Torchieres_2
{
    internal class Torchieres_2 : ModTile
    {
        public enum StyleID
        {
            StoneBrickTorchiere, //0
            RedBrickTorchiere, //1
            CinderblockTorchiere,
        }
        ...
        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
        {
            ...
            switch (style)
            {
                case StyleID.StoneBrickTorchiere:
                case StyleID.RedBrickTorchiere:
                case StyleID.CinderblockTorchiere:
                    r = 1f;
                    g = .85f;
                    b = .70f;
                    break;
        ...
        //    if (Main.rand.NextBool(40) && tileFrameX / 72 != 0)
        //    {
        //        StyleID style = (StyleID)TileObjectData.GetTileStyle(Main.tile[i, j]);
