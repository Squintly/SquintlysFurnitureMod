...
public class PaintJars : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        AddMapEntry(new Color(200, 200, 200), Language.GetText("Paint Jar"));
...
public class PaintJarsItem : ModItem
{
    public override void SetStaticDefaults()
    {
    ...
    public override void SetDefaults()
    {
        ...
        Item.DefaultToPlaceableTile(ModContent.TileType<PaintJars>());
    }
