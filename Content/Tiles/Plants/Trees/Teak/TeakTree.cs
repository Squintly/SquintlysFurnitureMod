...
public abstract class TeakTree : ModTree
{
    ...
    {
        GrowsOnTileId = [ModContent.TileType<TeakGrass>()];
        texture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Plants/Trees/TeakTree");
        branchesTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Plants/Trees/TeakTreeBranches");
        topsTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Plants/Trees/TeakTreeTops");
