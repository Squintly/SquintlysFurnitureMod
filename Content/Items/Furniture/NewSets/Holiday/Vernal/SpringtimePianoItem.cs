using SquintlysFurnitureMod.Content.Furniture.Surfaces.Pianos;
...
internal class SpringtimePianoItem : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.createTile = ModContent.TileType<SpringtimePiano>();
    }

    public override void AddRecipes()
    {
        CreateRecipe(1)
            .AddIngredient(ModContent.ItemType<SpringyWood>(), 15)
