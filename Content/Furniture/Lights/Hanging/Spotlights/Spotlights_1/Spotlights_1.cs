...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Hanging.Spotlights.Spotlights_1
{
    [LegacyName("Spotlights")]
    public class Spotlights_1 : ModTile
    {
        public enum StyleID
        {
            ImperialSpotlight, //0
            CinderblockSpotlight, //1
        }
        ...
        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
        {
            ...
            switch (style)
            {
                case StyleID.ImperialSpotlight: //Bright
                    r = 1f;
                    g = .95f;
                    b = .90f;
                    break;

                case StyleID.CinderblockSpotlight: //Yellowy
                    r = 1f;
                    g = .85f;
                    b = .70f;
                    break;
        ...
        public override void AdjustMultiTileVineParameters(int i, int j, ref float? overrideWindCycle, ref float windPushPowerX, ref float windPushPowerY, ref bool dontRotateTopTiles, ref float totalWindMultiplier, ref Texture2D glowTexture, ref Color glowColor)
        {
            ...
            switch (style)
            {
                case StyleID.CinderblockSpotlight:
                    overrideWindCycle = 0.8f;
                    break;

                case StyleID.ImperialSpotlight: //Default
                    break;
