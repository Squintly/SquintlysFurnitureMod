...
internal class BundledHeartBalloons : ModItem
{
	public override void SetStaticDefaults()
	{
		base.DisplayName.SetDefault("Bundled Heart Balloons");
	...
	public override void SetDefaults()
	{
		...
		base.Item.createTile = ModContent.TileType<BundledHeartBalloonTile>();
	...
	{
		base.CreateRecipe()
			.AddIngredient(ModContent.ItemType<HeartBalloon>(), 3)
