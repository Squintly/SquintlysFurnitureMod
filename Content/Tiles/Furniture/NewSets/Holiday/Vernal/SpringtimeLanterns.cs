...
{
    internal class SpringtimeLanterns : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Furniture/NewSets/Holiday/Vernal/SpringtimeLanterns_Flame"); // We could also reuse Main.FlameTexture[] textures, but using our own texture is nice.
            }
        ...
        public override IEnumerable<Item> GetItemDrops(int i, int j)
        {
            ...
            yield return new Item(Mod.Find<ModItem>(Lanterns_4_Items.GetInternalNameFromStyle(0)).Type);
        }
