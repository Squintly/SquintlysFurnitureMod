...
using SquintlysFurnitureMod.Content.Items.Decorations.Holiday.Halloween.Decorations.Pumpkins;
using Terraria;
...
namespace SquintlysFurnitureMod.Content.Tiles.Decorations.Holiday.Halloween.Decorations.Pumpkins
{
    internal class SmallPumpkins : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Decorations/Holiday/Halloween/Decorations/Pumpkins/SmallPumpkins_Flame"); // We could also reuse Main.FlameTexture[] textures, but using our own texture is nice.
            }

            AddMapEntry(new Color(200, 200, 200), Language.GetText("MapObject.Candle"));

            RegisterItemDrop(ModContent.ItemType<PumpkinSmallItem>());
        }
