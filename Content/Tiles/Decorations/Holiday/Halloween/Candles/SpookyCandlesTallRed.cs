...
{
    internal class SpookyCandlesTallRed : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Decorations/Holiday/Halloween/Candles/SpookyCandlesTallRed_Flame");
            }
            RegisterItemDrop(ModContent.ItemType<SpookyCandlesTallRedItem>());
        }
