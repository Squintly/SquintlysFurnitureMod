...
public class RepairedDoorOpen : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        TileID.Sets.CloseDoorID[Type] = ModContent.TileType<RepairedDoorClosed>();

        AddToArray(ref TileID.Sets.RoomNeeds.CountsAsDoor);

        AdjTiles = new int[] { TileID.OpenDoor };
        RegisterItemDrop(ModContent.ItemType<RepairedDoorItem>(), 0);
    ...
    public override void MouseOver(int i, int j)
    {
        ...
        player.cursorItemIconID = ModContent.ItemType<RepairedDoorItem>();
    }
}