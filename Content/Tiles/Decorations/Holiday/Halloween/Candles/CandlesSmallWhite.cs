...
{
    internal class CandlesSmallWhite : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Decorations/Holiday/Halloween/Candles/CandlesSmallWhite_Flame");
            }

            RegisterItemDrop(ModContent.ItemType<SpookyMeltedCandleWhite>());
        }
