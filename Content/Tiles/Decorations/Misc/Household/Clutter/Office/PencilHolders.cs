using SquintlysFurnitureMod.Content.Items.Decorations.Misc.Household.Clutter.Office.Supplies.Modern;
using Terraria;
...
namespace SquintlysFurnitureMod.Content.Tiles.Decorations.Misc.Household.Clutter.Office;

public class PencilHolders : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<PencilHolder>());
    }
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        short frameAdjustment = (short)(tile.TileFrameX >= 126 ? -126 : 18); //change last two depending on size
