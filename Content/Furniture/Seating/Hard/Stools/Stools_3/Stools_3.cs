...
namespace SquintlysFurnitureMod.Content.Furniture.Seating.Hard.Stools.Stools_3
{
    public class Stools_3 : ModTile
    {
        public enum StyleID
        {
            ImperialStool, //0
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            if (Main.tile[i, j].TileFrameX / 102 < 1)
            {
