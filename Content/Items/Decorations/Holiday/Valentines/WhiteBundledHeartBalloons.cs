...
internal class WhiteBundledHeartBalloons : ModItem
{
	public override void SetStaticDefaults()
	{
		base.DisplayName.SetDefault("White Bundled Heart Balloons");
	...
	public override void SetDefaults()
	{
		...
		base.Item.createTile = ModContent.TileType<WhiteBundledHeartBalloonTile>();
    }

	public override void AddRecipes()
	{
		base.CreateRecipe()
			.AddIngredient(ModContent.ItemType<WhiteHeartBalloon>(),3)
