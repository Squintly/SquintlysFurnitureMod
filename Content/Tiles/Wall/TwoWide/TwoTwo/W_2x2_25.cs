...
namespace SquintlysFurnitureMod.Content.Tiles.Wall.TwoWide.TwoTwo;

public class W_2x2_25 : ModTile
{
    public enum StyleID
    {
        WideTowels
    ...
    public override void SetStaticDefaults()
    {
        ...
        TileObjectData.newTile.StyleMultiplier = 25;
        TileObjectData.newTile.StyleWrapLimit = 25;
        TileObjectData.newTile.RandomStyleRange = 25;
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        short frameAdjustment = (short)(tile.TileFrameX >= 864 ? -864 : 36); //change first two by total size, last by style size
    ...
    public override void AdjustMultiTileVineParameters(int i, int j, ref float? overrideWindCycle, ref float windPushPowerX, ref float windPushPowerY, ref bool dontRotateTopTiles, ref float totalWindMultiplier, ref Texture2D glowTexture, ref Color glowColor)
    {
        ...
        switch (style)
        {
            case StyleID.WideTowels: //Stiff, no top
