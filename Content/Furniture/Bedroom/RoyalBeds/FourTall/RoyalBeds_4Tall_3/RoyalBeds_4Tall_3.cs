...
namespace SquintlysFurnitureMod.Content.Furniture.Bedroom.RoyalBeds.FourTall.RoyalBeds_4Tall_3
{
    [LegacyName("RoyalBeds_4Tall")]
    public abstract class RoyalBeds_4Tall_3 : ModTile //abstract
    {
    ...
    public class ImperialFourPosters : RoyalBeds_4Tall_3
    {
