...
namespace SquintlysFurnitureMod.Content.Tiles.Decorations.Holiday.Easter.Baskets;

public class PlantersFloral : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<PlanterFloral>());
    }
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        short frameAdjustment = (short)(tile.TileFrameX >= 108 ? -108 : 54); //change last two depending on size
