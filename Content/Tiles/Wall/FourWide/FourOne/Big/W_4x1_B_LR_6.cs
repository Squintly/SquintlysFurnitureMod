...
public class W_4x1_B_LR_6 : ModTile
{
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        {
            short frameAdjustment = (short)(tile.TileFrameX >= 792 ? -360 : 72); //change first two by total size - one style, last by style size
        ...
        {
            short frameAdjustment = (short)(tile.TileFrameX >= 360 ? -360 : 72); //change first two by total size - one style, last by style size
