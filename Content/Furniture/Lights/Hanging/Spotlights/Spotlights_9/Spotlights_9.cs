...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Hanging.Spotlights.Spotlights_9
{
    public class Spotlights_9 : ModTile
    {
        public enum StyleID
        {
            TatteredSpotlight, //0
        ...
        public void ToggleTile(int i, int j)
        {
            ...
            short frameAdjustment = (short)(tile.TileFrameX >= 324 ? -324 : 324);
        ...
        {
            if (Main.tile[i, j].TileFrameX / 324 != 0)
            {
                return;
            }
            ...
            switch (style)
            {
                case StyleID.TatteredSpotlight: //Dim, Reddish
                    r = 1f;
                    g = .75f;
                    b = .65f;
                    break;

                case StyleID.RepairedSpotlight: //Bright
                    r = 1f;
                    g = .85f;
                    b = .85f;
                    break;
        ...
        public override void AdjustMultiTileVineParameters(int i, int j, ref float? overrideWindCycle, ref float windPushPowerX, ref float windPushPowerY, ref bool dontRotateTopTiles, ref float totalWindMultiplier, ref Texture2D glowTexture, ref Color glowColor)
        {
            ...
            switch (style)
            {
                case StyleID.TatteredSpotlight:
                    totalWindMultiplier *= 0.8f;
                    break;

                case StyleID.RepairedSpotlight: //Default
                    break;
        ...
        public override void GetTileFlameData(int i, int j, ref TileDrawing.TileFlameData tileFlameData)
        {
            ...
            switch (style)
            {
                case StyleID.TatteredSpotlight: //Dim, low flicker
                ...
                case StyleID.RepairedSpotlight: //Medium, no flicker
