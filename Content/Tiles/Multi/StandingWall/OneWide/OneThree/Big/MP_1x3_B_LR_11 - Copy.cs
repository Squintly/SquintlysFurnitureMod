...
public class MP_1x3_B_LR_11 : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        TileObjectData.addAlternate(11);
        ...
        RegisterItemDrop(ModContent.ItemType<Sword>(), 0);
    }
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        if (tile.TileFrameX >= 352)
        {
            short frameAdjustment = (short)(tile.TileFrameX >= 672 ? -320 : 32); //change first two by total size - one style, last by style size
        ...
        {
            short frameAdjustment = (short)(tile.TileFrameX >= 320 ? -320 : 32); //change first two by total size - one style, last by style size
