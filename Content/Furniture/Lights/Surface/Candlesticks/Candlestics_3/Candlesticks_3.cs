...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Surface.Candlesticks.Candlestics_3
{
    internal class Candlesticks_3 : ModTile
    {
        public enum StyleID
        {
            ImperialCandlestick, //0
        }
        ...
        public void ToggleTile(int i, int j)
        {
            ...
            short frameAdjustment = (short)(tile.TileFrameX >= 102 ? -102 : 102);
        ...
        {
            if (Main.tile[i, j].TileFrameX / 102 != 0)
            {
                return;
            }
            ...
            switch (style)
            {
                case StyleID.ImperialCandlestick:
                    r = 1f;
                    g = .95f;
                    b = .9f;
                    break;
        ...
        //            if (Main.rand.NextBool(40) && frameX >= 35)
        //            {
