...
internal class SpringyWoodGreenItem : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.createTile = ModContent.TileType<SpringyWoodGreen>();
    }
    ...
    public override void AddRecipes()
    {
        ...
        CreateRecipe()
           .AddIngredient(ModContent.ItemType<SpringyWoodGreenWallItem>(), 4)
           .AddTile(TileID.WorkBenches)
           .Register();
    }
}