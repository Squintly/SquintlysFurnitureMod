...
{
	internal class FestiveCandle : ModTile
	{
		...
		public override void SetStaticDefaults() {
            ...
            base.ItemDrop = ModContent.ItemType<FestiveCandleItem>();

            AddToArray(ref TileID.Sets.RoomNeeds.CountsAsTorch);

            AddMapEntry(new Color(79, 71, 58), base.CreateMapEntryName("Festive Candle"));

            if (!Main.dedServ) {
				flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Furniture/NewSets/Festive/FestiveCandle_Flame"); // We could also reuse Main.FlameTexture[] textures, but using our own texture is nice.
			}
		}	
