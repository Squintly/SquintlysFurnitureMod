...
public class S_1x1_B_2_Lighted : ModTile
{
    ...
    public override void SetStaticDefaults()
    {
        ...
        if (!Main.dedServ)
        {
            flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Surface/OneWide/OneOne/Big/S_1x1_B_2_Lighted_Flame");
        }
    }
...
/* STYLES
0- Blue Birthday Slice
1- Pink Birthday Slice
2- Green Birthday Slice
3- Birthday Cupcake
*/