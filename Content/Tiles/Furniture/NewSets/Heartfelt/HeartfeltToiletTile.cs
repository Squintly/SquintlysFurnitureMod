...
{
	public class HeartfeltToiletTile : ModTile
	{
		...
		public override void SetStaticDefaults() {
            ...
            AddMapEntry(new Color(252, 3, 3), base.CreateMapEntryName("Heartfelt Toilet"));
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<HeartfeltToilet>());
		}
		...
		public override void MouseOver(int i, int j) {
			...
			player.cursorItemIconID = ModContent.ItemType<HeartfeltToilet>();
