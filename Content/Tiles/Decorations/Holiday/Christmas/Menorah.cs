...
namespace SquintlysFurnitureMod.Content.Tiles.Decorations.Holiday.Christmas
{
	internal class Menorah : ModTile
	{
		...
		public override void SetStaticDefaults() {
            ...
            AddMapEntry(new Color(79, 71, 58), Language.GetText("Festive Decoration"));
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(x, y), x * 16, y * 16, 48, 32, ModContent.ItemType<MenorahItem>());
        }
