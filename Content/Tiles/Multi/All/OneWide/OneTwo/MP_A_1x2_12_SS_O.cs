...
namespace SquintlysFurnitureMod.Content.Tiles.Multi.All.OneWide.OneTwo
{
    public class MP_A_1x2_12_SS_O : ModTile
    {
        public enum StyleID
        {
            BannerWhiteFlatShort, //0
            BannerWhitePointShort, //1
            BannerGrayFlatShort, //2
            BannerGrayPointShort, //3
            BannerBlackFlatShort, //4
            BannerBlackPointShort, //5
            BannerPastelFlatShort, //6
            BannerPastelPointShort, //7
            BannerBrightFlatShort, //8
            BannerBrightPointShort, //9
            BannerNavyFlatShort, //10
            BannerNavyPointShort, //11
            BannerPaleFlatShort, //12
            BannerPalePointShort, //13
            BannerDullFlatShort, //14
            BannerDullPointShort, //15
            BannerDimFlatShort, //16
            BannerDimPointShort //17
        }
        ...
        public void ToggleTile(int i, int j)
        {
            ...
            {
                short frameAdjustment = (short)(tile.TileFrameX >= 198 ? -198 : 18);
            ...
            if (tile.TileFrameX >= 216 & tile.TileFrameX < 432)
            {
                short frameAdjustment = (short)(tile.TileFrameX >= 414 ? -198 : 18);
            ...
            if (tile.TileFrameX >= 432 & tile.TileFrameX < 648)
            {
                short frameAdjustment = (short)(tile.TileFrameX >= 630 ? -198 : 18);
            ...
            if (tile.TileFrameX >= 648)
            {
                short frameAdjustment = (short)(tile.TileFrameX >= 846 ? -198 : 18);
