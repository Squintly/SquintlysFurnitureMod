...
namespace SquintlysFurnitureMod.Content.Furniture.Misc.Mirrors.Wide.Mirrors_Wide_1
{
    [LegacyName("Mirrors_Wide")]
    public class Mirrors_Wide_1 : ModTile
    {
        public enum StyleID
        {
            ImperialWideMirror, //0
            TatteredWideMirror, //1
            RepairedWideMirror, //2
            StoneBrickWideMirror, //3
            RedBrickWideMirror, //4
            CinderblockWideMirror //5
        }
