...
namespace SquintlysFurnitureMod.Content.Furniture.Seating.Soft.Chesterfields.Chesterfields_6
{
    public class Chesterfields_3Tall_6 : ModTile
    {
        public enum StyleID
        {
            TatteredChesterfield, //0
            RepairedChesterfield //1
        }
        ...
        public override void ModifySittingTargetInfo(int i, int j, ref TileRestingInfo info)
        {
            ...
            info.AnchorTilePosition.Y = (tile.TileFrameY % 56 == 0) ? (j + 1) : j;
