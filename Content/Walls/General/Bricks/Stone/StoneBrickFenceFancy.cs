...
public class StoneBrickFenceFancy : FenceLargeLazure
{
...
public class StoneBrickFenceFancyItem : ModItem
{
    ...
    {
        Item.DefaultToPlaceableWall(ModContent.WallType<StoneBrickFenceFancy>());
