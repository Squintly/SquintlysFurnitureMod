...
public class S_1x1_B_3 : ModTile
{
    public enum StyleID
    {
        Peach,
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        if (!shiftPressed)
        {
            short frameAdjustment = (short)(tile.TileFrameX >= 68 ? -68 : 34); //change first two by total size, last by style size
        ...
        if (shiftPressed)
        {
            short frameAdjustment = (short)(tile.TileFrameX < 34 ? 68 : -34); //change first two by total size, last by style size
