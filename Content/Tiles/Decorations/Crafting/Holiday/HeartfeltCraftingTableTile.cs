...
namespace SquintlysFurnitureMod.Content.Tiles.Decorations.Crafting.Holiday
{
    public class HeartfeltCraftingTableTile : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Decorations/Crafting/Holiday/HeartfeltCraftingTableTile_Flame"); // We could also reuse Main.FlameTexture[] textures, but using our own texture is nice.
            }
