...
namespace SquintlysFurnitureMod.Content.Tiles.Furniture.NewSets.Holiday.Festive
{
    internal class FestiveLamppost : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Furniture/NewSets/Holiday/Festive/FestiveLamppost_Flame");
            }
            RegisterItemDrop(ModContent.ItemType<FestiveLamppostItem>());
