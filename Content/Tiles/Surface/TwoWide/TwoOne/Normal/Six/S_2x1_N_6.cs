...
namespace SquintlysFurnitureMod.Content.Tiles.Surface.TwoWide.TwoOne.Normal.Six;

public class S_2x1_N_6 : ModTile
{
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        short frameAdjustment = (short)(tile.TileFrameX >= 180 ? -180 : 36); //change first two by total size, last by style size
