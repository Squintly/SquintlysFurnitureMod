...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Hanging.Chandeliers.Chandeliers_2
{
    internal class Chandeliers_2 : ModTile
    {
        public enum StyleID
        {
            StoneBrickChandelier, //0
            RedBrickChandelier, //1
        }
        ...
        public void ToggleTile(int i, int j)
        {
            ...
            short frameAdjustment = (short)(tile.TileFrameX >= 108 ? -108 : 108);
        ...
        {
            if (Main.tile[i, j].TileFrameX / 108 != 0)
            {
                return;
            }
            ...
            switch (style)
            {
                case StyleID.StoneBrickChandelier:
                case StyleID.RedBrickChandelier:
                    r = 1f;
                    g = .85f;
                    b = .70f;
                    break;
        ...
        //    if (Main.rand.NextBool(40) && tileFrameX / 108 != 0)
        //    {
        //        StyleID style = (StyleID)TileObjectData.GetTileStyle(Main.tile[i, j]);
