...
public class MP_1x4_B_6 : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<SpearLong>(), 0);
    }
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        short frameAdjustment = (short)(tile.TileFrameX >= 160 ? -160 : 32); //change first two by total size - one style, last by style size
