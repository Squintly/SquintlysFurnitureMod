...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Hanging.Spotlights.Spotlights_2
{
    public class Spotlights_2 : ModTile
    {
        ...
        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
        {
            ...
            switch (style)
            {
                case StyleID.TeakSpotlight: //Dim, Reddish
                    r = 1f;
                    g = .75f;
                    b = .75f;
                    break;

                case StyleID.StoneBrickSpotlight:
                case StyleID.RedBrickSpotlight:
                    r = 1f;
                    g = .85f;
                    b = .70f;
                    break;
        ...
        public override void GetTileFlameData(int i, int j, ref TileDrawing.TileFlameData tileFlameData)
        {
            ...
            switch (style)
            {
                case StyleID.TeakSpotlight: //Low, no flicker
                case StyleID.StoneBrickSpotlight:
                case StyleID.RedBrickSpotlight:
