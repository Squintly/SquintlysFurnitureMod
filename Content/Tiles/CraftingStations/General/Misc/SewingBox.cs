...
public class SewingBox : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        AddMapEntry(new Color(138, 94, 54), Language.GetText("Sewing Box"));

        AdjTiles = new int[] { ModContent.TileType<Thread>() };
    }
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        if (shiftPressed)
        {
            short frameAdjustment = (short)(tile.TileFrameX > 36 ? 288 : -36); //change first two by total size, last by style size
...
public class SewingBoxItem : ModItem
{
    public override void SetStaticDefaults()
    {
    ...
    public override void SetDefaults()
    {
        ...
        Item.DefaultToPlaceableTile(ModContent.TileType<SewingBox>());
    }
