using SquintlysFurnitureMod.Content.Items.Decorations.VanillaPlus.Plants;
using Terraria;
...
namespace SquintlysFurnitureMod.Content.Tiles.Decorations.VanillaPlus.Plants;

public class SilkMushrooms : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<SilkMushroomsItem>());
