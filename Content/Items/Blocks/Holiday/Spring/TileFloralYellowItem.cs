...
internal class TileFloralYellowItem : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.createTile = ModContent.TileType<TileFloralYellow>();
    }
    ...
    public override void AddRecipes()
    {
        ...
        CreateRecipe()
           .AddIngredient(ModContent.ItemType<TileFloralYellowWallItem>(), 4)
