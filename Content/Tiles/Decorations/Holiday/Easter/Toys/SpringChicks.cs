...
using SquintlysFurnitureMod.Content.Items.Decorations.Holiday.Easter.Toys;
using Terraria;
...
public class SpringChicks : ModTile
{
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        int topY = j - tile.TileFrameY % 28 / 28;

        short frameAdjustment = (short)(tile.TileFrameX >= 110 ? -110 : 22); //change last two depending on size
