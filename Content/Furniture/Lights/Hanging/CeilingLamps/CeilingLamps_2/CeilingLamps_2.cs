...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Hanging.CeilingLamps.CeilingLamps_2
{
    internal class CeilingLamps_2 : ModTile
    {
        public enum StyleID
        {
            TatteredCeilingLamp, //0
            RepairedCeilingLamp, //1
            StoneBrickCeilingLamp, //2
            RedBrickCeilingLamp, //3
        }
        ...
        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
        {
            ...
            switch (style)
            {
                ...
                case StyleID.StoneBrickCeilingLamp:
                case StyleID.RedBrickCeilingLamp:
                    r = 1f;
                    g = .85f;
                    b = .70f;
                    break;
        ...
        public override void AdjustMultiTileVineParameters(int i, int j, ref float? overrideWindCycle, ref float windPushPowerX, ref float windPushPowerY, ref bool dontRotateTopTiles, ref float totalWindMultiplier, ref Texture2D glowTexture, ref Color glowColor)
        {
            ...
            switch (style)
            {
                case StyleID.TatteredCeilingLamp: //Still
                ...
                case StyleID.StoneBrickCeilingLamp: //Default
                case StyleID.RedBrickCeilingLamp:
                    overrideWindCycle = 0f;
                    break;
