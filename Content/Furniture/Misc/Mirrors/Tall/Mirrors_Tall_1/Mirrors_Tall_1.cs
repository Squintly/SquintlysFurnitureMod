...
namespace SquintlysFurnitureMod.Content.Furniture.Misc.Mirrors.Tall.Mirrors_Tall_1
{
    [LegacyName("Mirrors_Tall")]
    public class Mirrors_Tall_1 : ModTile
    {
        public enum StyleID
        {
            ImperialTallMirror, //0
            StoneBrickTallMirror, //1
            RedBrickTallMirror, //2
            CinderblockTallMirror //3
        }
