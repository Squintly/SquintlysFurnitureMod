...
internal class PlasterBlueWornItem : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.createTile = ModContent.TileType<PlasterBlueWorn>();
    }
    ...
    public override void AddRecipes()
    {
        ...
        CreateRecipe()
           .AddIngredient(ModContent.ItemType<PlasterBlueWornWallItem>(), 4)
           .AddTile(TileID.WorkBenches)
           .Register();
    }
}