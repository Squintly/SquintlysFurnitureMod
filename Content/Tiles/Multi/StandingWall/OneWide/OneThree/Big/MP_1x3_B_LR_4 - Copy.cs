...
public class MP_1x3_B_LR_4 : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<GunStanding>(), 0);
        RegisterItemDrop(ModContent.ItemType<HammerLong>(), 1);
        RegisterItemDrop(ModContent.ItemType<Axe>(), 2);
    }
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        if (tile.TileFrameX >= 128)
        {
            short frameAdjustment = (short)(tile.TileFrameX >= 224 ? -96 : 32); //change first two by total size - one style, last by style size
