...
namespace SquintlysFurnitureMod.Content.Furniture.Bedroom.Beds.ThreeTall.Beds_3Tall_1
{
    public class Beds_3Tall_1 : ModTile
    {
        public enum StyleID
        {
            StoneBrickCanopyBed, //0
            RedBrickCanopyBed, //1
            CinderblockCanopyBed, //2
        }
