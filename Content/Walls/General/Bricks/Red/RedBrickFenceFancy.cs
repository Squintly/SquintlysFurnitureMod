...
public class RedBrickFenceFancy : FenceLargeLazure
{
...
public class RedBrickFenceFancyItem : ModItem
{
    ...
    {
        Item.DefaultToPlaceableWall(ModContent.WallType<RedBrickFenceFancy>());
