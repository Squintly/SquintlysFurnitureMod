...
namespace SquintlysFurnitureMod.Content.Furniture.Bedroom.RoyalBeds.TwoTall.RoyalBeds_2Tall_1
{
    public class RoyalBeds_2Tall_1 : ModTile
    {
        public enum StyleID
        {
            StoneBrickRoyalBed, //0
            RedBrickRoyalBed, //1
            CinderblockRoyalBed, //2
        }

        public const int NextStyleHeight = 34; //Calculated by adding all CoordinateHeights + CoordinatePaddingFix.Y applied to all of them + 2
        ...
        public override void ModifySmartInteractCoords(ref int width, ref int height, ref int frameWidth, ref int frameHeight, ref int extraY)
        {
            ...
            extraY = 0;            //extraY = 0; // Depends on how you set up frameHeight and CoordinateHeights and CoordinatePaddingFix.Y
        }
