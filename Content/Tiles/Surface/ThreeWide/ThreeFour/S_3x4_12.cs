...
namespace SquintlysFurnitureMod.Content.Tiles.Surface.ThreeWide.ThreeFour;

public class S_3x4_12 : ModTile
{
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        short frameAdjustment = (short)(tile.TileFrameX >= 594 ? -594 : 54); //change first two by total size - one style, last by style size
        ...
        {
            NetMessage.SendTileSquare(-1, topX, topY, 3, 4); //change for width, height
        }
    }
}
