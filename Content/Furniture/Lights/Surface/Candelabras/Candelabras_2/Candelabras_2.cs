...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Surface.Candelabras.Candelabras_2
{
    public class Candelabras_2 : ModTile
    {
        public enum StyleID
        {
            ImperialCandelabra, //0
            CinderblockCandelabra, //1
        }
        ...
        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
        {
            ...
            switch (style)
            {
                case StyleID.ImperialCandelabra: //Cool
                    r = 1f;
                    g = .95f;
                    b = .8f;
                    break;

                case StyleID.CinderblockCandelabra:
                    r = 1f;
                    g = .85f;
                    b = .70f;
                    break;
