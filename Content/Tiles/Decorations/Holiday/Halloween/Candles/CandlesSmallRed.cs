...
{
    internal class CandlesSmallRed : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Decorations/Holiday/Halloween/Candles/CandlesSmallRed_Flame");
            }

            RegisterItemDrop(ModContent.ItemType<SpookyMeltedCandleRed>());
        }
