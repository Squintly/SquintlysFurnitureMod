...
{
	public class HeartfeltChestTile : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			ChestDrop = ModContent.ItemType<HeartfeltChest>();

			ContainerName.SetDefault("Heartfelt Chest");

            AddMapEntry(new Color(252, 3, 3), base.CreateMapEntryName("Heartfelt Chest"));
		...
		public override void MouseOver(int i, int j) {
			...
			if (chest < 0) {
				...
				if (player.cursorItemIconText == defaultName) {
					player.cursorItemIconID = ModContent.ItemType<HeartfeltChest>();
