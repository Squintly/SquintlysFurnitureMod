...
public class FishBarrelTile : ModTile
{
	public override void SetStaticDefaults()
	{
		...
		base.ChestDrop = ModContent.ItemType<FishBarrel>();
		base.ContainerName.SetDefault("Fish Barrel");
	...
	public override void MouseOver(int i, int j)
	{
		...
		{
			player.cursorItemIconText = ((Main.chest[chest].name.Length > 0) ? Main.chest[chest].name : "Fish Barrel");
			if (player.cursorItemIconText == "Fish Barrel")
			{
