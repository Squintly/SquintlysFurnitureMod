...
namespace SquintlysFurnitureMod.Content.Tiles.Furniture.NewSets.Heartfelt
{
    public class HeartfeltPianoTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            // Etc
            AddMapEntry(new Color(252, 3, 3), base.CreateMapEntryName("Heartfelt Piano"));
        }

        public override void KillMultiTile(int x, int y, int frameX, int frameY)
        {
            Item.NewItem(new EntitySource_TileBreak(x, y), x * 16, y * 16, 48, 32, ModContent.ItemType<HeartfeltPiano>());
        }
    }
}
