...
public class TowelsNarrow : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<TowelNarrow>());
    }
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        short frameAdjustment = (short)(tile.TileFrameX >= 324 ? -324 : 18); //change last two depending on size
