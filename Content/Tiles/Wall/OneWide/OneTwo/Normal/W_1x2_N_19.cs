...
namespace SquintlysFurnitureMod.Content.Tiles.Wall.OneWide.OneTwo.Normal;

public class W_1x2_N_19 : ModTile
{
    public enum StyleID
    {
        LongTowels
    ...
    public override void SetStaticDefaults()
    {
        ...
        TileObjectData.newTile.StyleMultiplier = 19;
        TileObjectData.newTile.StyleWrapLimit = 19;
        TileObjectData.newTile.RandomStyleRange = 19;
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        short frameAdjustment = (short)(tile.TileFrameX >= 324 ? -324 : 18); //change first two by total size, last by style size
    ...
    public override void AdjustMultiTileVineParameters(int i, int j, ref float? overrideWindCycle, ref float windPushPowerX, ref float windPushPowerY, ref bool dontRotateTopTiles, ref float totalWindMultiplier, ref Texture2D glowTexture, ref Color glowColor)
    {
        ...
        switch (style)
        {
            case StyleID.LongTowels: //Stiff, no top
