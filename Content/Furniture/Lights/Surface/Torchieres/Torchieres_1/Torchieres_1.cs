...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Surface.Torchieres.Torchieres_1
{
    [LegacyName("Torchieres")]
    internal class Torchieres_1 : ModTile
    {
        public enum StyleID
        {
            ImperialTorchiere, //0
        ...
        //    if (Main.rand.NextBool(40) && tileFrameX / 36 != 0)
        //    {
        //        StyleID style = (StyleID)TileObjectData.GetTileStyle(Main.tile[i, j]);
        ...
        //    switch (style)
        //    {
        //        case StyleID.ImperialTorchiere: //Low glow, low flicker
