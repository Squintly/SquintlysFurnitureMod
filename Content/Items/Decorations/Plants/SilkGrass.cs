...
internal class SilkGrass : ModItem
{
	public override void SetStaticDefaults()
	{
		base.DisplayName.SetDefault("Silk Grass");
	...
	public override void SetDefaults()
	{
		...
		base.Item.createTile = ModContent.TileType<SilkGrassTile>();
	}

	public override void AddRecipes()
	{
		base.CreateRecipe().AddIngredient(4048).AddIngredient(225)
			.AddTile(18)
			.Register();
	}
}
