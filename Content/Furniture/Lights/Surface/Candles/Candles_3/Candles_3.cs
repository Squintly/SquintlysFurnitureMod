...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Surface.Candles.Candles_3
{
    internal class Candles_3 : ModTile
    {
        public enum StyleID
        {
            ImperialCandle, //0
            TatteredCandle, //1
            TatteredSilverCandle, //2
            RepairedCandle, //3
            RepairedSilverCandle, //4
            StoneBrickCandle, //5
            RedBrickCandle, //6
        }
        ...
        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
        {
            ...
            switch (style)
            {
                case StyleID.ImperialCandle: //Cool
                    r = 1f;
                    g = .95f;
                    b = .8f;
                    break;
        ...
        public override void EmitParticles(int i, int j, Tile tileCache, short tileFrameX, short tileFrameY, Color tileLight, bool visible)
        {
            ...
            if (Main.rand.NextBool(40) && tileFrameX < 102)
            {
                StyleID style = (StyleID)TileObjectData.GetTileStyle(Main.tile[i, j]);
