using SquintlysFurnitureMod.Content.Items.Decorations.Misc.Household.Clutter.Office.Supplies.Old;
using Terraria;
...
public class Inkwell : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<InkwellItem>());
    }
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        int topY = j - tile.TileFrameY % 24 / 24;
