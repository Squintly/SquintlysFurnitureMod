...
{
	public class Armchairs : ModTile
	{
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) 
		{
            ...
            {
                case 0:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.WoodenLawnchair>();
                    break;
                case 1:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.WoodenArmchair>();
                    break;
                case 2:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.EbonwoodArmchair>();
                    break;
                case 3:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.MahoganyArmchair>();
                    break;
                case 4:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.PearlwoodArmchair>();
                    break;
                case 5:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.ShadewoodArmchair>();
                    break;
                case 6:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.BlueDungeonArmchair>();
                    break;
                case 7:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.GreenDungeonArmchair>();
                    break;
                case 8:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.PinkDungeonArmchair>();
                    break;
                case 9:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.GoldenArmchair>();
                    break;
                case 10:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.ObsidianArmchair>();
                    break;
				case 11:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.BoneArmchair>();
                    break;
                case 12:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.CactusArmchair>();
                    break;
                case 13:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.SpookyArmchair>();
                    break;
                case 14:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.SkywareArmchair>();
                    break;
                case 15:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.HoneyArmchair>();
                    break;
                case 16:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.SteampunkArmchair>();
                    break;
                case 17:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.MushroomArmchair>();
                    break;
                case 18:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.BeanbagArmchair>();
                    break;
                case 19:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.GlassArmchair>();
                    break;
                case 20:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.PumpkinArmchair>();
                    break;
                case 21:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.LihzahrdArmchair>();
                    break;
                case 22:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.PalmwoodLawnchair>();
                    break;
                case 23:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.PalmwoodArmchair>();
                    break;
                case 24:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.MushroomLawnchair>();
                    break;
                case 25:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.BorealArmchair>();
                    break;
                case 26:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.SlimeArmchair>();
                    break;
                case 27:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.FleshArmchair>();
                    break;
                case 28:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.FrozenArmchair>();
                    break;
                case 29:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.LivingwoodArmchair>();
                    break;
                case 30:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.MartianArmchair>();
                    break;
                case 31:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.MeteorArmchair>();
                    break;
                case 32:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.GraniteArmchair>();
                    break;
                case 33:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.MarbleArmchair>();
                    break;
                case 34:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.CrystalArmchair>();
                    break;
                case 35:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.DynastyArmchair>();
                    break;
                case 36:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.SpiderArmchair>();
                    break;
                case 37:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.LesionArmchair>();
                    break;
                case 38:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.SolarArmchair>();
                    break;
                case 39:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.VortexArmchair>();
                    break;
                case 40:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.NebulaArmchair>();
                    break;
                case 41:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.StardustArmchair>();
                    break;
                case 42:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.SandstoneArmchair>();
                    break;
                case 43:
                    item = ModContent.ItemType<Items.Furniture.SetExtras.Armchairs.BambooArmchair>();
                    break;
