...
internal class PurpleSilkFlowers : ModItem
{
	...
	{
		base.DisplayName.SetDefault("Purple Silk Flowers");
	...
	public override void SetDefaults()
	{
		...
		base.Item.createTile = ModContent.TileType<PurpleSilkFlowersTile>();
	}

	public override void AddRecipes()
	{
		base.CreateRecipe().AddIngredient(4046).AddIngredient(225)
			.AddTile(18)
			.Register();
	}
}
