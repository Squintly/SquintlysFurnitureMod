...
public class NewYears1x1 : ModTile
{
    ...
    public override bool Drop(int i, int j)
    {
        ...
        if (frame == 0)
            item = ModContent.ItemType<ChampagneFlutesItem>();

        else if (frame == 1)
            item = ModContent.ItemType<TopHat>();

        else if (frame == 2)
            item = ModContent.ItemType<ChampagneFluteItem>();
