...
{
	public class TatteredChestTile : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			ChestDrop = ModContent.ItemType<Items.Furniture.NewSets.Tattered.TatteredChestItem>();

			ContainerName.SetDefault("Tattered Chest");

            AddMapEntry(new Color(79, 71, 58), base.CreateMapEntryName("Tattered Chest"));
		...
		public override void MouseOver(int i, int j) {
			...
			if (chest < 0) {
				...
				if (player.cursorItemIconText == defaultName) {
					player.cursorItemIconID = ModContent.ItemType<Items.Furniture.NewSets.Tattered.TatteredChestItem>();
