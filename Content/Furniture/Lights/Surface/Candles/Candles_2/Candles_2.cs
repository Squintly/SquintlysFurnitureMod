...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Surface.Candles.Candles_2
{
    internal class Candles_2 : ModTile
    {
        public enum StyleID
        {
            CinderblockCandle, //0
        ...
        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
        {
            ...
            switch (style)
            {
                case StyleID.CinderblockCandle: //Cool
                    r = 1f;
                    g = .85f;
                    b = .70f;
                    break;
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            //     new Vector2(i * 32 - (int)Main.screenPosition.X, j * 32 - (int)Main.screenPosition.Y) + zero,
            //     new Rectangle(tile.TileFrameX, tile.TileFrameY, 32, 32),
