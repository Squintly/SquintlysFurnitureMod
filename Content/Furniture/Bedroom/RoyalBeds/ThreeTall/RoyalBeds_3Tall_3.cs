...
namespace SquintlysFurnitureMod.Content.Furniture.Bedroom.RoyalBeds.ThreeTall
{
    public class RoyalBeds_3Tall_3 : ModTile
    {
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            int spawnX = i - tile.TileFrameX / 18 + (tile.TileFrameX >= 432 ? 5 : 2);
            int spawnY = j + 3;
