...
namespace SquintlysFurnitureMod.Content.Items.Decorations.Holiday.Halloween.Alchemy.Glass;

internal class FlaskSmall : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.createTile = ModContent.TileType<SmokeVial>();
        Item.placeStyle = 0;
    }
