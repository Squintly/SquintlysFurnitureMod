...
internal class TileCheckeredBlueWallItem : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.createWall = ModContent.WallType<TileCheckeredBlueWall>();
    }

    public override void AddRecipes()
    {
        CreateRecipe(4)
           .AddIngredient(ModContent.ItemType<TileCheckeredBlueItem>())
