...
namespace SquintlysFurnitureMod.Content.Furniture.Misc.Mirrors.Tall.Mirrors_Tall_2
{
    public class Mirrors_Tall_2 : ModTile
    {
        public enum StyleID
        {
            TatteredTallMirror, //0
            RepairedTallMirror, //1
        }
