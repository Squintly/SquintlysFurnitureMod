...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Hanging.TrackLights.TrackLights_2
{
    public class TrackLights_2 : ModTile
    {
        public enum StyleID
        {
            CinderblockTrackLight, //0
        }
        ...
        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
        {
            ...
            switch (style)
            {
                case StyleID.CinderblockTrackLight:
                    r = 1f;
                    g = .85f;
                    b = .70f;
                    break;
