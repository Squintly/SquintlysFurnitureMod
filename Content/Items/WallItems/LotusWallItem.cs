...
internal class LotusWallItem : ModItem
{
	public override void SetStaticDefaults()
	{
		base.DisplayName.SetDefault("Lotus Wall");
	...
	public override void SetDefaults()
	{
		...
		base.Item.createWall = ModContent.WallType<LotusWall>();
	}

	public override void AddRecipes()
	{
        base.CreateRecipe(4)
           .AddIngredient(ModContent.ItemType<LotusBlockItem>())
