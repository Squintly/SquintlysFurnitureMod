...
public class SilkJunglePlantsTile : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<SilkJunglePlants>());
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        short frameAdjustment = (short)(tile.TileFrameX >= 468 ? -468 : 18); //change last two depending on size
