...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Hanging.Lanterns.Lanterns_4
{
    public class Lanterns_4 : ModTile
    {
        public enum StyleID
        {
            VernalLantern, //0
        ...
        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
        {
            ...
            switch (style)
            {
                case StyleID.VernalLantern: //Bright, slightly yellow
                    r = 1f;
                    g = 1f;
                    b = .85f;
                    break;

                case StyleID.StoneBrickLantern:
                case StyleID.RedBrickLantern:
                    r = 1f;
                    g = .85f;
                    b = .70f;
                    break;
        ...
        public override void AdjustMultiTileVineParameters(int i, int j, ref float? overrideWindCycle, ref float windPushPowerX, ref float windPushPowerY, ref bool dontRotateTopTiles, ref float totalWindMultiplier, ref Texture2D glowTexture, ref Color glowColor)
        {
            ...
            switch (style)
            {
                ...
                case StyleID.VernalLantern: //Default
                    break;
        ...
        public override void GetTileFlameData(int i, int j, ref TileDrawing.TileFlameData tileFlameData)
        {
            ...
            switch (style)
            {
                case StyleID.VernalLantern: //Low glow, no flicker
                case StyleID.StoneBrickLantern:
                case StyleID.RedBrickLantern:
