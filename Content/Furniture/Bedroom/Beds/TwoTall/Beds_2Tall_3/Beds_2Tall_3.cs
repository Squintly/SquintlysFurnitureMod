...
namespace SquintlysFurnitureMod.Content.Furniture.Bedroom.Beds.TwoTall.Beds_2Tall_3
{
    [LegacyName("Beds_3")]
    public abstract class Beds_2Tall_3 : ModTile
    {
    ...
    public class ImperialBeds : Beds_2Tall_3
    {
