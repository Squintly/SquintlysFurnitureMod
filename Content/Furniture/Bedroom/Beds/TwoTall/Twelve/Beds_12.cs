...
namespace SquintlysFurnitureMod.Content.Furniture.Bedroom.Beds.TwoTall.Twelve
{
    public abstract class Beds_12 : ModTile
    {
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            int spawnX = i - tile.TileFrameX / 18 + (tile.TileFrameX >= 38 ? 5 : 2);
            int spawnY = j + 2;
    ...
    public class TatteredBeds : Beds_12
    {
