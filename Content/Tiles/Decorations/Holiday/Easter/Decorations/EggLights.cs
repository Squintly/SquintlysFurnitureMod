...
{
    internal class EggLights : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            RegisterItemDrop(ModContent.ItemType<EggLight>());

            AddToArray(ref TileID.Sets.RoomNeeds.CountsAsTorch);

            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Decorations/Holiday/Easter/Decorations/EggLights_Flame");
            }
        }
