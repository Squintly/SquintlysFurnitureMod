...
{
	public class FestiveToilet : ModTile
	{
		...
		public override void SetStaticDefaults() {
            ...
            AddMapEntry(new Color(12, 69, 6), base.CreateMapEntryName("Festive Toilet"));
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<FestiveToiletItem>());
		}
		...
		public override void MouseOver(int i, int j) {
			...
			player.cursorItemIconID = ModContent.ItemType<FestiveToiletItem>();
