...
namespace SquintlysFurnitureMod.Content.Tiles.Decorations.Holiday.Christmas.Lights
{
    internal class BigCandles : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Decorations/Holiday/Christmas/Lights/BigCandles_Flame");
            }
        }
