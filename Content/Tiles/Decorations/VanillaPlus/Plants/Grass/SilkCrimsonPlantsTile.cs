using SquintlysFurnitureMod.Content.Items.Decorations.VanillaPlus.Plants.Grass;
using Terraria;
...
namespace SquintlysFurnitureMod.Content.Tiles.Decorations.VanillaPlus.Plants.Grass;

public class SilkCrimsonPlantsTile : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<SilkCrimsonPlants>());
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        short frameAdjustment = (short)(tile.TileFrameX >= 378 ? -378 : 18); //change last two depending on size
