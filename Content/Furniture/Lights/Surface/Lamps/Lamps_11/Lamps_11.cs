...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Surface.Lamps.Lamps_11
{
    internal class Lamps_11 : ModTile
    {
        public enum StyleID
        {
            TatteredLamp, //0
        ...
        public override void SetStaticDefaults()
        {
            ...
            AddMapEntry(new Color(230, 200, 50), Language.GetText("MapObject.Lamp"));
        }
        ...
        public void ToggleTile(int i, int j)
        {
            ...
            short frameAdjustment = (short)(tile.TileFrameX >= 374 ? -374 : 374); //change last two depending on size
        ...
        {
            if (Main.tile[i, j].TileFrameX / 374 != 0)
            {
                return;
            }
            ...
            switch (style)
            {
                case StyleID.TatteredLamp: //Tattered
                    r = 1f;
                    g = .75f;
                    b = .75f;
                    break;

                case StyleID.RepairedLamp: //Repaired
                    r = 1f;
                    g = .95f;
                    b = .95f;
                    break;
        ...
        //    if (Main.rand.NextBool(40) && tileFrameX / 374 != 0)
        //    {
        //        StyleID style = (StyleID)TileObjectData.GetTileStyle(Main.tile[i, j]);
        ...
        //    switch (style)
        //    {
        //        case StyleID.TatteredLamp: //Low glow, low flicker
        ...
        //        case StyleID.RepairedLamp: //Low glow, low flicker
