...
public class W_4x1_B_LR_4 : ModTile
{
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        {
            short frameAdjustment = (short)(tile.TileFrameX >= 504 ? -216 : 72); //change first two by total size - one style, last by style size
        ...
        {
            short frameAdjustment = (short)(tile.TileFrameX >= 216 ? -216 : 72); //change first two by total size - one style, last by style size
