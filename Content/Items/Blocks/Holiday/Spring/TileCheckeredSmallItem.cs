...
internal class TileCheckeredSmallItem : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.createTile = ModContent.TileType<TileCheckeredSmall>();
    }
    ...
    public override void AddRecipes()
    {
        ...
        CreateRecipe()
           .AddIngredient(ModContent.ItemType<TileCheckeredSmallWallItem>(), 4)
           .AddTile(TileID.WorkBenches)
           .Register();
    }
}