...
internal class HieroBlock : ModItem
{
	public override void SetStaticDefaults()
	{
		base.DisplayName.SetDefault("Hieroglyphic Block");
		base.Tooltip.SetDefault("Anyone find my bangle?");
	...
	public override void SetDefaults()
	{
		...
		base.Item.createTile = ModContent.TileType<HieroBlockTile>();
		base.Item.placeStyle = 0;
	}

	public override void AddRecipes()
	{
		base.CreateRecipe().AddIngredient(ModContent.ItemType<FadedHieroBlock>()).AddTile(18)
			.Register();
		base.CreateRecipe().AddIngredient(607).AddTile(18)
			.Register();
		base.CreateRecipe().AddIngredient(ModContent.ItemType<HieroWallItem>(), 4).AddTile(18)
			.Register();
	}
}
