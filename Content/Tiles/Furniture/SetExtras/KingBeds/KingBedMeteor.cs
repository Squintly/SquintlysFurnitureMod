...
namespace SquintlysFurnitureMod.Content.Tiles.Furniture.SetExtras.KingBeds
{
    public class KingBedMeteor : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Furniture/SetExtras/KingBeds/KingBedMeteor_Flame"); // We could also reuse Main.FlameTexture[] textures, but using our own texture is nice.
            }
        }
