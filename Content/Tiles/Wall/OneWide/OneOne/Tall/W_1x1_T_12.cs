...
namespace SquintlysFurnitureMod.Content.Tiles.Wall.OneWide.OneOne.Tall;

public class W_1x1_T_12 : ModTile
{
    public enum StyleID
    {
        Stockings //0
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        short frameAdjustment = (short)(tile.TileFrameX >= 198 ? -198 : 18); //change first two by total size, last by style size
    ...
    public override void AdjustMultiTileVineParameters(int i, int j, ref float? overrideWindCycle, ref float windPushPowerX, ref float windPushPowerY, ref bool dontRotateTopTiles, ref float totalWindMultiplier, ref Texture2D glowTexture, ref Color glowColor)
    {
        ...
        switch (style)
        {
            case StyleID.Stockings: //Banner, anchored top
