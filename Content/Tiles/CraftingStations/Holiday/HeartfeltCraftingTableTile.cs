...
namespace SquintlysFurnitureMod.Content.Tiles.CraftingStations.Holiday
{
    public class HeartfeltCraftingTableTile : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/CraftingStations/Holiday/HeartfeltCraftingTableTile_Flame"); // We could also reuse Main.FlameTexture[] textures, but using our own texture is nice.
            }
