...
public class W_4x1_B_LR_2 : ModTile
{
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        {
            short frameAdjustment = (short)(tile.TileFrameX >= 216 ? -72 : 72); //change first two by total size - one style, last by style size
        ...
        {
            short frameAdjustment = (short)(tile.TileFrameX >= 72 ? -72 : 72); //change first two by total size - one style, last by style size
