...
{
    internal class CandleHolders : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Decorations/Holiday/Halloween/Candles/CandleHolders_Flame");
            }
        }
        ...
        public void ToggleTile(int i, int j)
        {
            ...
            int topY = j - tile.TileFrameY % 26 / 18;
