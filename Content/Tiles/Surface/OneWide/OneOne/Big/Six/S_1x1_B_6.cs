...
public class S_1x1_B_6 : ModTile
{
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        if (!shiftPressed)
        {
            ...
            short frameAdjustment = (short)(tile.TileFrameX >= 170 ? -170 : 34); //change first two by total size, last by style size
        ...
        if (shiftPressed)
        {
            ...
            short frameAdjustment = (short)(tile.TileFrameX < 34 ? 170 : -34); //change first two by total size, last by style size
