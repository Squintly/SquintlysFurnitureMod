...
internal class ImperialWorkBench : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.DefaultToPlaceableTile(ModContent.TileType<WorkBenches_5>());
        Item.placeStyle = 0;
    }
    ...
    {
        CreateRecipe()
            .AddRecipeGroup(ModContent.TileType<ImperialWood>(), 10)
