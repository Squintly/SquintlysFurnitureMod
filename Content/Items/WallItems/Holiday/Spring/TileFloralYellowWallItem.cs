...
internal class TileFloralYellowWallItem : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.createWall = ModContent.WallType<TileFloralYellowWall>();
    }

    public override void AddRecipes()
    {
        CreateRecipe(4)
           .AddIngredient(ModContent.ItemType<TileFloralYellowItem>())
