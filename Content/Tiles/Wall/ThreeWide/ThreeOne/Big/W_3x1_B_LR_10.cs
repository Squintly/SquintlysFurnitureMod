...
namespace SquintlysFurnitureMod.Content.Tiles.Wall.ThreeWide.ThreeOne.Big;

public class W_3x1_B_LR_10 : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        TileObjectData.addAlternate(10);
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        if (tile.TileFrameX >= 540)
        {
            short frameAdjustment = (short)(tile.TileFrameX >= 1026 ? -486 : 54); //change first two by total size - one style, last by style size
        ...
        {
            short frameAdjustment = (short)(tile.TileFrameX >= 486 ? -486 : 54); //change first two by total size - one style, last by style size
