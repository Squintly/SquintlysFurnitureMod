...
namespace SquintlysFurnitureMod.Content.Furniture.Bedroom.RoyalBeds.ThreeTall.RoyalBeds_3Tall_6
{
    public abstract class RoyalBeds_3Tall_6 : ModTile
    {
        public const int NextStyleHeight = 56; //Calculated by adding all CoordinateHeights + CoordinatePaddingFix.Y applied to all of them + 2
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            int spawnX = i - tile.TileFrameX / 18 + (tile.TileFrameX >= 72 ? 5 : 2); // (First Block) + ( if more than 4 blocks, than 5, otherwise 2);
            int spawnY = j + 3;
    ...
    public class TatteredRoyalBeds : RoyalBeds_3Tall_6
    {
    ...
    public class RepairedRoyalBeds : RoyalBeds_3Tall_6
    {
        public override void SafeSetStaticDefaults()
        {
        }
