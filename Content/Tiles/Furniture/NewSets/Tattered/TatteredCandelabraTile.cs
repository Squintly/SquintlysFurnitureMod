...
namespace SquintlysFurnitureMod.Content.Tiles.Furniture.NewSets.Tattered
{
	internal class TatteredCandelabraTile : ModTile
	{
		...
		public override void SetStaticDefaults() {
            ...
            AddMapEntry(new Color(79, 71, 58), Language.GetText("Tattered Candelabra"));

			if (!Main.dedServ) {
				flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Furniture/NewSets/Tattered/TatteredCandelabraTile_Flame");
			}
		}
