...
using SquintlysFurnitureMod.Content.Abstracts.Methods;
...
namespace SquintlysFurnitureMod.Content.Furniture.Bedroom.Beds
{
    public class Beds_3 : ModTile
    {
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            if (!ModifyHover.IsHoveringOverABottomSideOfABed3(i, j))
