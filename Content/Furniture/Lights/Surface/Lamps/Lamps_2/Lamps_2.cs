...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Surface.Lamps.Lamps_2
{
    internal class Lamps_2 : ModTile
    {
        public enum StyleID
        {
            CinderblockLamp, //0
        ...
        public void ToggleTile(int i, int j)
        {
            ...
            short frameAdjustment = (short)(tile.TileFrameX >= 68 ? -68 : 68); //change last two depending on size
        ...
        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
        {
            ...
            switch (style)
            {
                case StyleID.CinderblockLamp: //Tattered
                    r = 1f;
                    g = .85f;
                    b = .70f;
                    break;
