using SquintlysFurnitureMod.Content.Items.Decorations.Holiday.Halloween.Alchemy.Glass;
using Terraria;
...
public class SmokeVial : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<FlaskSmall>());
    }
