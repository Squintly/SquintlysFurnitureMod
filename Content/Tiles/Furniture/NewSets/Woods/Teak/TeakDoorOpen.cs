...
public class TeakDoorOpen : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        TileID.Sets.CloseDoorID[Type] = ModContent.TileType<TeakDoorClosed>();

        AddToArray(ref TileID.Sets.RoomNeeds.CountsAsDoor);

        AdjTiles = new int[] { TileID.OpenDoor };
        RegisterItemDrop(ModContent.ItemType<TeakDoorItem>(), 0);
    ...
    public override void MouseOver(int i, int j)
    {
        ...
        player.cursorItemIconID = ModContent.ItemType<TeakDoorItem>();
    }
}