...
public class W_1x1_N_26 : ModTile
{
    public enum StyleID
    {
        SmallTowels
    ...
    public override void SetStaticDefaults()
    {
        ...
        TileObjectData.newTile.StyleMultiplier = 26;
        TileObjectData.newTile.StyleWrapLimit = 26;
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        short frameAdjustment = (short)(tile.TileFrameX >= 450 ? -450 : 18); //change first two by total size, last by style size
    ...
    public override void AdjustMultiTileVineParameters(int i, int j, ref float? overrideWindCycle, ref float windPushPowerX, ref float windPushPowerY, ref bool dontRotateTopTiles, ref float totalWindMultiplier, ref Texture2D glowTexture, ref Color glowColor)
    {
        ...
        switch (style)
        {
            case StyleID.SmallTowels: //Default, anchored top
