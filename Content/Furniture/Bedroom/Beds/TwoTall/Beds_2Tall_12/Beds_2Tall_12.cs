...
namespace SquintlysFurnitureMod.Content.Furniture.Bedroom.Beds.TwoTall.Beds_2Tall_12
{
    [LegacyName("Beds_12")]
    public abstract class Beds_2Tall_12 : ModTile
    {
    ...
    public class TatteredBeds : Beds_2Tall_12
    {
    ...
    public class RepairedBeds : Beds_2Tall_12
    {
        public override void SafeSetStaticDefaults()
        {
        }
