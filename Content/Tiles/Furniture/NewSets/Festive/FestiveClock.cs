...
{
	public class FestiveClock : ModTile
	{
		public override void SetStaticDefaults() {
            ...
            AddMapEntry(new Color(12, 69, 6), base.CreateMapEntryName("Festive Clock")); 
        }
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY) {
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 48, 32, ModContent.ItemType<FestiveClockItem>());
		}
	}
}