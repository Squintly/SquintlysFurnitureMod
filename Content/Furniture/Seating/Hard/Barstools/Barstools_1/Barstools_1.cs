...
namespace SquintlysFurnitureMod.Content.Furniture.Seating.Hard.Barstools.Barstools_1
{
    [LegacyName("Barstools")]
    public class Barstools_1 : ModTile
    {
        public enum StyleID
        {
            StoneBrick, //0
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            if (Main.tile[i, j].TileFrameX / 34 < 1)
            {
