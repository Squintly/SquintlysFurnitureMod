...
public class TowelsWide : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<TowelWide>());
    }
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        short frameAdjustment = (short)(tile.TileFrameX >= 1548 ? -1548 : 36); //change last two depending on size
        ...
        {
            NetMessage.SendTileSquare(-1, topX, topY, 2, 1); //width, height
        }
    }
}