...
public class S_1x1_N_13 : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        TileObjectData.newTile.StyleMultiplier = 13;
        TileObjectData.newTile.StyleWrapLimit = 13;
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        short frameAdjustment = (short)(tile.TileFrameX >= 216 ? -216 : 18); //change depending width
