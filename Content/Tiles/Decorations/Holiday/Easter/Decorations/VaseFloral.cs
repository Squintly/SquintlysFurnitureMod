...
using SquintlysFurnitureMod.Content.Items.Decorations.Misc.Household.Decor.Vases;
using Terraria;
...
namespace SquintlysFurnitureMod.Content.Tiles.Decorations.Holiday.Easter.Decorations;

public class VasesFloral : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<VaseFloral>());
    }
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        int topX = i - tile.TileFrameX % 22 / 22; //change first number depending on size
        int topY = j - tile.TileFrameY % 32 / 32;

        short frameAdjustment = (short)(tile.TileFrameX >= 154 ? -154 : 22); //change last two depending on size
