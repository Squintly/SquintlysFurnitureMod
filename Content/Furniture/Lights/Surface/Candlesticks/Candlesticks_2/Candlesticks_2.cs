...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Surface.Candlesticks.Candlesticks_2
{
    internal class Candlesticks_2 : ModTile
    {
        public enum StyleID
        {
            StoneBrickCandlestick, //0
            RedBrickCandlestick, //1
            CinderblockCandlestick, //2
        }
        ...
        public void ToggleTile(int i, int j)
        {
            ...
            int topY = j - tile.TileFrameY % 32 / 16;

            short frameAdjustment = (short)(tile.TileFrameX >= 68 ? -68 : 68);
        ...
        public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
        {
            ...
            switch (style)
            {
                case StyleID.StoneBrickCandlestick:
                case StyleID.RedBrickCandlestick:
                case StyleID.CinderblockCandlestick:
                    r = 1f;
                    g = .85f;
                    b = .70f;
                    break; //yellow bright
        ...
        public override void EmitParticles(int i, int j, Tile tileCache, short tileFrameX, short tileFrameY, Color tileLight, bool visible)
        {
            ...
            //if (Main.rand.NextBool(40) && tileFrameX / 170 != 0)
            //{
            //    StyleID style = (StyleID)TileObjectData.GetTileStyle(Main.tile[i, j]);
            ...
            //    switch (style)
            //    {
            //        case StyleID.TatteredCandlestick:
            //        case StyleID.TatteredSilverCandlestick:
            //        case StyleID.RepairedCandlestick:
            //        case StyleID.RepairedSilverCandlestick:
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            switch (style)
            {
                ...
                case StyleID.CinderblockCandlestick:
                    for (int c = 0; c < 1; c++)
                    {
                        float shakeX = Utils.RandomInt(ref randSeed, -5, 6) * 0.05f;
