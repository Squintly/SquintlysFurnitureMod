...
namespace SquintlysFurnitureMod.Content.Furniture.Lights.Hanging.Lanterns.Lanterns_11
{
    public class Lanterns_11 : ModTile
    {
        public enum StyleID
        {
            TatteredLantern, //0
        ...
        public void ToggleTile(int i, int j)
        {
            ...
            short frameAdjustment = (short)(tile.TileFrameX >= 198 ? -198 : 198);
        ...
        {
            if (Main.tile[i, j].TileFrameX / 198 != 0)
            {
                return;
            }
            ...
            switch (style)
            {
                case StyleID.TatteredLantern: //Dim, Reddish
                    r = 1f;
                    g = .75f;
                    b = .65f;
                    break;

                case StyleID.RepairedLantern: //Warm
                    r = 1f;
                    g = .85f;
                    b = .85f;
                    break;
        ...
        public override void AdjustMultiTileVineParameters(int i, int j, ref float? overrideWindCycle, ref float windPushPowerX, ref float windPushPowerY, ref bool dontRotateTopTiles, ref float totalWindMultiplier, ref Texture2D glowTexture, ref Color glowColor)
        {
            ...
            switch (style)
            {
                case StyleID.TatteredLantern: //Default
                case StyleID.RepairedLantern:
                    break;
        ...
        public override void GetTileFlameData(int i, int j, ref TileDrawing.TileFlameData tileFlameData)
        {
            ...
            switch (style)
            {
                case StyleID.TatteredLantern: //Dim, small medium flicker
                    tileFlameData.flameCount = 1;
                    tileFlameData.flameColor = new Color(100, 100, 100, 0);
                    tileFlameData.flameRangeXMin = -3;
                    tileFlameData.flameRangeXMax = 4;
                    tileFlameData.flameRangeYMin = -3;
                    tileFlameData.flameRangeYMax = 1;
                    tileFlameData.flameRangeMultX = 0.15f;
                    tileFlameData.flameRangeMultY = 0.15f;
                    break;

                case StyleID.RepairedLantern: //Medium glow, no flicker
                    tileFlameData.flameCount = 1;
                    tileFlameData.flameColor = new Color(100, 100, 100, 0);
