...
public class SilkJungleFlowersTile : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        RegisterItemDrop(ModContent.ItemType<SilkJungleFlowers>());
    ...
    public void ToggleTile(int i, int j)
    {
        ...
        short frameAdjustment = (short)(tile.TileFrameX >= 162 ? -162 : 18); //change last two depending on size
