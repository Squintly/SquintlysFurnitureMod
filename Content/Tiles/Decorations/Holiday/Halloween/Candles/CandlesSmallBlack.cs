...
using SquintlysFurnitureMod.Content.Items.Decorations.Holiday.Halloween.Candles.Melted;
using Terraria;
...
{
    internal class CandlesSmallBlack : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Decorations/Holiday/Halloween/Candles/CandlesSmallBlack_Flame");
            }

            RegisterItemDrop(ModContent.ItemType<SpookyMeltedCandleBlack>());
        }
        ...
        public void ToggleTile(int i, int j)
        {
            ...
            int topY = j - tile.TileFrameY % 22 / 18;
