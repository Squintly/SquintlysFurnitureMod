...
namespace SquintlysFurnitureMod.Content.Tiles.Furniture.SetExtras.CeilingLamps
{
    internal class CeilingLampsTile : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                flameTexture = ModContent.Request<Texture2D>("SquintlysFurnitureMod/Content/Tiles/Furniture/SetExtras/CeilingLamps/CeilingLampsTile_Flame"); // We could also reuse Main.FlameTexture[] textures, but using our own texture is nice.
            }
        }
